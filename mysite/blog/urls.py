...
urlpatterns = [
	...
	path('company/<int:pk>/delete/', CompanyDelete.as_view(), name='company_delete_url'),
	...
	path('subcategory/<int:pk>/delete/', SubcategoryDelete.as_view(), name='subcategory_delete_url'),
